    ...
    <div className="w-full bg-soul-950 border-y-4 border-neutral-900 shadow-2xl animate-fade-in relative overflow-hidden">
      ...
      <div className="px-6 md:px-12 pb-12 relative z-10">
        ...
        <div className="text-center mb-8">
            <h2 className="text-3xl md:text-5xl text-neutral-200 font-display uppercase tracking-widest drop-shadow-md">
                {data.name}
            </h2>
            <p className="text-soul-accent/80 text-sm md:text-base uppercase tracking-[0.2em] font-display mt-2 border-b border-soul-accent/20 inline-block pb-1 px-4">
                {data.epithet}
            </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div className="space-y-6">
                 <p className="italic text-neutral-400 leading-relaxed text-lg text-justify font-serif">
                    {data.description}
                </p>
            ...
            <div className="space-y-4 text-sm">
                 ...
                 <div className="bg-black/30 border border-neutral-800 p-4">
                    <h4 className="text-red-900/80 uppercase font-display tracking-widest mb-2 text-xs">Weaknesses</h4>
                 ...
                 {/* Resistances */}
                 <div className="bg-black/30 border border-neutral-800 p-4">
                    <h4 className="text-neutral-600 uppercase font-display tracking-widest mb-2 text-xs">Resistances</h4>
                    <div className="flex flex-wrap gap-2">
        ...
        {data.phases && data.phases.length > 0 && (
            <div className="mt-8 pt-8 border-t border-neutral-900">
                <h3 className="text-center font-display text-neutral-500 uppercase tracking-widest text-sm mb-6">Combat Phases</h3>
                <div className="space-y-4">
                    {data.phases.map((phase, i) => (
                        <div key={i} className="flex gap-4">
                            <span className="text-soul-accent font-display text-xl opacity-50">IV I II III IV V VI'.split(' ')[i+1]</span>
                            <p className="text-neutral-400 font-serif leading-relaxed">{phase}</p>
                        </div>
                    ))}
                </div>
            </div>
