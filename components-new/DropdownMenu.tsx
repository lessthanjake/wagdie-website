...
export const DropdownItem = React.memo<DropdownItemProps>(({
  ...
  return (
    <button
      ...
      className={`
        block w-full text-left px-4 py-2 text-sm font-serif text-neutral-400
...
export const DropdownLabel: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div
    role="presentation"
    className="px-4 py-2 text-xs font-display uppercase tracking-widest text-neutral-600 border-b border-neutral-900 mb-1"
  >
    {children}
  </div>
);
