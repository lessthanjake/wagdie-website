  ...
  return (
    <footer className="bg-soul-950 border-t border-neutral-800 mt-auto relative">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-center gap-8 flex-wrap mb-6">
          {externalLinks.map((link) => (
            <a
              ...
              className="text-neutral-600 hover:text-soul-accent transition-colors duration-300 min-h-[44px] flex items-center font-display uppercase tracking-widest text-xs"
            >
              {link.label}
        ...
        <p className="text-center text-neutral-700 text-xs font-serif">
