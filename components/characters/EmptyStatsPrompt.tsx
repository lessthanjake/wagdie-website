...
export function EmptyStatsPrompt({
  ...
  return (
    <div className={`bg-black/40 border border-neutral-700 p-6 text-center ${className}`}>
      ...
      <h3 className="text-lg font-display uppercase tracking-widest text-neutral-300 mb-2">
        No Stats Assigned
      </h3>
      ...
      <button
        ...
        className="px-6 py-2 bg-soul-accent/20 border border-soul-accent text-soul-accent font-display uppercase tracking-widest text-sm hover:bg-soul-accent/30 transition-colors"
      >
        Assign Stats
      </button>
    </div>
